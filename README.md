...
> Preparing for interviews? See [INTERVIEW.md](./INTERVIEW.md) for the elevator pitch, architecture walkthrough, and Q&A bank.
...
└── INTERVIEW.md             # interview prep + Q&A bank
```
...
Moved to [INTERVIEW.md](./INTERVIEW.md) — elevator pitch, Q&A bank, scaling story, and tradeoffs.
